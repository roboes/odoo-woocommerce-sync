...
class WoocommerceSyncConnector(models.Model):
    ...
    @staticmethod
    def list_chunks(items: list, chunk_size: int) -> Generator[list, Any]:
    ...
    @api.model
    def woocommerce_api_get_items_in_batches(self: models.Model, woocommerce_api: WooCommerceClient, endpoint: str, params: dict[str, Any] | None = None, batch_size: int = 10) -> Generator[list[dict[str, Any]], Any]:
        self.ensure_one()
